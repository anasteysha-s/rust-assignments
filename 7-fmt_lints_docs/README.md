...
- Enable the following Rust lints and fix warning (run `cargo build` and you will see):
    ...
    - `unreachable_pub`
- Enable the following `clippy` lints for the entire codebase and fix clippy warning (run `cargo clippy` and you will see):
